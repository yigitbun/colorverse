...
export const atlasWorlds = [
  {
    ...
    starters: [
      { name: 'Prism Light', colors: ['#F6F1E5', '#F2C05E', '#DA5B7A', '#4C7CC8', '#292A4A'] },
      { name: 'Reef Current', colors: ['#E7F7F3', '#9CDDD2', '#2E9AAB', '#E86E5B', '#12394A'] },
      { name: 'Civic Shadow', colors: ['#E8E1D8', '#B7B0A8', '#A87558', '#5A5165', '#1C2026'] },
    ],
  },
  {
    ...
    starters: [
      { name: 'Patina Cycle', colors: ['#F1E4D4', '#B7C0BC', '#8E5B3F', '#41606A', '#202D33'] },
      { name: 'Dune Signal', colors: ['#F5E6C8', '#D8A474', '#B86D43', '#718A74', '#30383A'] },
      { name: 'Archive Green', colors: ['#F5EBDD', '#D7C4A8', '#5D765F', '#A4483F', '#2B2928'] },
    ],
  },
  {
    ...
    starters: [
      { name: 'Forest Floor', colors: ['#F4F1EA', '#D9D3C0', '#3A6B3E', '#A38450', '#1F2C1D'] },
      { name: 'Quiet Workshop', colors: ['#F4EFE7', '#D9CBB8', '#B0A096', '#72836F', '#2B2A27'] },
      { name: 'Night Garden', colors: ['#D9E9D0', '#63D9EE', '#9D7CFF', '#EF6C9B', '#132F39'] },
    ],
  },
  {
    ...
    starters: [
      { name: 'Ocean Breeze', colors: ['#F0F8F8', '#CFE7E5', '#1FAFA0', '#F4C977', '#1B3B3A'] },
      { name: 'Market Signal', colors: ['#FFF2D6', '#F5C247', '#F28B2B', '#6E9A62', '#273D3C'] },
      { name: 'Low Cloud', colors: ['#E9E8E2', '#AEB9B8', '#6D888B', '#3E5054', '#1A2629'] },
    ],
  },
  {
    ...
    starters: [
      { name: 'Nordic Calm', colors: ['#F5F7FA', '#E4E9F0', '#2D5BFF', '#7FA8FF', '#1A2330'] },
      { name: 'Midnight Tech', colors: ['#0B1220', '#15203A', '#22D3EE', '#A78BFA', '#E2E8F0'] },
      { name: 'Soft Voltage', colors: ['#FFE9F0', '#9D7CFF', '#63D9EE', '#E8FF5F', '#322447'] },
    ],
  },
  {
    ...
    starters: [
      { name: 'After Hours', colors: ['#121A22', '#253B43', '#E84E82', '#7B5CFF', '#F5D36A'] },
      { name: 'Bold Minimal', colors: ['#FAFAFA', '#EDEDED', '#E11D48', '#171717', '#0A0A0A'] },
      { name: 'Warm Cafe', colors: ['#FBF6F0', '#F0E3D2', '#8B5A3C', '#D17F3F', '#3E2A1F'] },
    ],
  },
];

...
- Original pricing intent (free + Pro coming soon), neutral product information, and a description of local image processing. There is no simulated account, payment, or waitlist backend. Personal attribution, biography, and external personal-site links are excluded from the published pages.
